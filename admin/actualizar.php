...
<html lang="es" dir="ltr">
  <head>
    ...
    if (!empty($_POST['actualizarSubmit'])) {
      ...
      $instruccion = "UPDATE productos SET nombre = '".$nombre."', descripcion = '".$descripcion."', cantidad = '".$cantidad."', precio = '".$precio."' WHERE id = '".$id."'";

      mysqli_query($coneccionBD, $instruccion);

      $msg = "Producto actualizados exitosamente";
